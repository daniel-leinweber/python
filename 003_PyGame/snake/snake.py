...
"""
Pygame implementation of the Game 'Snake'
"""
import random
...
class Cube():
    """The Cube object is used for the snake parts as well as the snacks"""
    rows = 20
    width = 500
...
class Snake():
    """The snake class controls the snake the player is playing"""
    body = []
    turns = {}
